...
const sendInfoRoute = require('./routes/sendInfoRoute');
const app = express();
...
const limiter = rateLimit({
    max: 100,
    windowMs: 60 * 60 * 1000,
    message: 'Za duzo wejść na stronę z tego adresu IP. Spróbuj ponownie za godzinę!',
});
app.use('/api', limiter);
...
app.use('/remonty/email', sendInfoRoute);
